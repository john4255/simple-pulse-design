...
from OpenFUSIONToolkit.TokaMaker.util import create_isoflux, create_power_flux_fun, read_eqdsk
...
#         ax[0].plot(timesteps[1:]*1.E3,volt_hist[:,coil['id']],label=name)
#     if name.startswith('PF'):
#         ax[1].plot(timesteps[1:]*1.E3,volt_hist[:,coil['id']],label=name)
# for ax_tmp in ax:
#     ax_tmp.grid(True)
#     ax_tmp.set_xlim(left=0.0)
