...
widthp_Te = 0.1
widthp_ne = 0.35
ne_flattop = Hmode_profiles(edge=0.35, ped=0.6, core=1.1, rgrid=n_sample, expin=1.6, expout=1.6, widthp=widthp_ne, xphalf=xphalf) * 1e20
Te_flattop = Hmode_profiles(edge=1500., ped=5000., core=21000., rgrid=n_sample, expin=1.3, expout=1.7, widthp=widthp_Te, xphalf=xphalf)
ni_flattop = ne_flattop.copy() # Assuming quasineutrality
Ti_flattop = Te_flattop.copy() # Assuming isothermal
p_flattop = (1.602e-19 * ne_flattop * Te_flattop) + (1.602e-19 * ni_flattop * Ti_flattop) # 1.602e-19 * [m^-3] * [eV] = [Pa]
...
mysim = DISMAL(0, 600, eqtimes=times, g_eqdsk_arr=g_arr, times=t_res, dt=1.0, last_surface_factor=0.99)
...
mysim.set_pedestal(set_pedestal=ped_on) # turn pedestal off for testing
