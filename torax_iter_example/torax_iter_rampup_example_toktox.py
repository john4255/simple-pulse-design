# 2026-02-19 toktox run staying as close to possible to TORAX's included iter rampup example
...
geqdsk_arr = [f'eqdsk_{i}.eqdsk' for i in range(10)]  # t=0 to t=80 in 10s increments
eqtimes = np.linspace(0, 80, 10)
