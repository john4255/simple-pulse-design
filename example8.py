...
# https://www-pub.iaea.org/mtcd/meetings/pdfplus/2010/cn180/cn180_papers/itr_p1-20.pdf

# Set timesteps
rampup_times = np.linspace(10.0, 60.0, 10)
...
mysim.set_heating(eccd=eccd_powers, eccd_loc=0.45) # TODO: check if ECCD is working
